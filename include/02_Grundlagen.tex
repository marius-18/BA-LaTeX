...
Ein \fett{Global \ct{}} besteht aus mehreren Curveball-Tauschen, wobei möglichst 
jeder Knoten aus der \red{aktiven Partitionsklasse}
...
Da es innerhalb der aktiven Partitionsklasse \red{\Large hier nochmal gucken..}
...
\red{Die ausgewählte Partitionsklasse wird als aktiv bezeichnet.}
