...
Um dies zu erreichen, führen wir mehrere Runden durch, in denen der Vektor $u$ von anfänglich 128
...
Dabei existiert jedoch kein Element, welches in beiden Vektoren enthalten ist, was dazu führen würde, dass ein \gc{} 
...
Größe von $v$.
\red{Der Wert \fett{\fr} steht dabei für den prozentualen Anteil der gemeinsamen Elemente \red{an} $v$.}
...
dieser Vorgang 
%durch den Google Benchmark Parameter \texttt{benchmark\_repetitions} 
jeweils fünf mal wiederholt. 
\red{Als resultierender Messwert dient der Mittelwert dieser Wiederholungen. }
\\
...
\centering
	...
	\caption{\red{Slowdown der einzelnen Varianten im jeweiligen Vergleich zur Variante mit der geringsten Laufzeit}}
...
\section{\red{Vergleich zum Standard \gc{}}}
\label{kap:result}
...
Weiterhin wird auch der \red{Standard \cb{} Algorithmus (was wurde angepasst??)} 
...
\centering
	...
	\caption{Laufzeitvergleich von bipartitem \gc{} und der abgeänderten Version des \cb{s}.{}
