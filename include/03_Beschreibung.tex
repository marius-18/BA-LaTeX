...
in einem Array vor. Der Übersichtlichkeit \blue{wegen}, werden wir die beiden
...
muss, um sie wieder aufrecht zu erhalten. Ob das \red{Vorsortieren} zu einem Vorteil führt, wird im Kapitel 
...
binären Suche. \red{Je nach Implementierung des Suchbaums könnte es aber auch zu einer verbesserten
Laufzeit führen.} 
...
Diese Laufzeit hängt jedoch stark von der Implementierung und dem \red{Füllgrad}  der Hash-Tabelle ab. 
...
\red{\Large Optimierung um floats zu vermeiden erwähnen}
\\
